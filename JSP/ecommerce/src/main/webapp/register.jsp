...
<div id="container">
    <div id="login">
        <form id="form-login" action="/ecommerce/register" method="post">
            <%
                if (error != null) {
            %>
            ...
            <div class="login-input">
                <input type="text" name="username" <% if (request.getParameter("username") != null){ %>
                       value="<%=request.getParameter("username") %>" <%} %> placeholder="username or email">
            </div>
            <div class="login-input">
